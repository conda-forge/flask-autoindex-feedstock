About flask-autoindex-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-autoindex-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/sublee/flask-autoindex
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2942&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-autoindex-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-autoindex` can be installed with `conda`:
...
```
mamba install flask-autoindex
```

It is possible to list all of the versions of `flask-autoindex` available on your platform with `conda`:
...
```
mamba search flask-autoindex --channel conda-forge
```
...
mamba repoquery search flask-autoindex --channel conda-forge

# List packages depending on `flask-autoindex`:
mamba repoquery whoneeds flask-autoindex --channel conda-forge

# List dependencies of `flask-autoindex`:
mamba repoquery depends flask-autoindex --channel conda-forge
```
